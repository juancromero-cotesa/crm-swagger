...
export interface ApiKey { 
    ...
    key?: string;
    /**
     * Id de la aplicación a la que pertenece la Key
     */
    externalAplicationId: string;
    /**
     * Urls de origen dede la que se permite el uso de la key
     */
    allowedOrigins: Array<string>;
    /**
     * roles de la Apikey que definirán que y sobre qué podrá actuar la apiKey
     */
    roles: Array<Role>;
    created?: string;
    createdBy?: UserBasic;
