...
export class PersonasService {
     ...
     * 
     * 
     * @param body Establece encuesta de valoración global del servicio del ayuntamiento en el array de las valoracione de la persona del usuario en sesión.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public personsSurveyPost(body: Survey, observe?: 'body', reportProgress?: boolean): Observable<Survey>;
    public personsSurveyPost(body: Survey, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Survey>>;
    public personsSurveyPost(body: Survey, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Survey>>;
    public personsSurveyPost(body: Survey, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling personsSurveyPost.');
        }
        ...
        return this.httpClient.request<Survey>('post',`${this.basePath}/persons/survey`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
