...
@Injectable()
export class CuadrosDeMandoService {
    ...
    /**
     * Obtiene todos los cuadros de mando (BORRADOR)
     * Método pendiende de análisis
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public controlPanelGet(observe?: 'body', reportProgress?: boolean): Observable<Array<ControlPanel>>;
    public controlPanelGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ControlPanel>>>;
    public controlPanelGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ControlPanel>>>;
    public controlPanelGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<ControlPanel>>('get',`${this.basePath}/controlPanel`,
            {
    ...
    /**
     * Obiene cuadro de mando (BORRADOR)
     * Método pendiende de análisis
     * @param controlPanelId 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public controlPanelsControlPanelIdGet(controlPanelId: string, observe?: 'body', reportProgress?: boolean): Observable<ControlPanel>;
    public controlPanelsControlPanelIdGet(controlPanelId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ControlPanel>>;
    public controlPanelsControlPanelIdGet(controlPanelId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ControlPanel>>;
    public controlPanelsControlPanelIdGet(controlPanelId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (controlPanelId === null || controlPanelId === undefined) {
            throw new Error('Required parameter controlPanelId was null or undefined when calling controlPanelsControlPanelIdGet.');
        }
        ...
        return this.httpClient.request<ControlPanel>('get',`${this.basePath}/controlPanels/${encodeURIComponent(String(controlPanelId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
