...
import { FilterAuditRequest } from '../model/filterAuditRequest';
...
export class AuditoraService {
    ...
    /**
     * Filtro sobre los registros de auditoría
     * 
     * @param body filterAuditRequest
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public auditFilterPost(body: FilterAuditRequest, observe?: 'body', reportProgress?: boolean): Observable<SearchResponse>;
    public auditFilterPost(body: FilterAuditRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SearchResponse>>;
    public auditFilterPost(body: FilterAuditRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SearchResponse>>;
    public auditFilterPost(body: FilterAuditRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling auditFilterPost.');
        }
        ...
        return this.httpClient.request<SearchResponse>('post',`${this.basePath}/audit/filter`,
            {
                body: body,
    ...
    /**
     * 
     * método de búsqaueda mediante filtro en auditorías
     * @param body 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public auditSearchPost(body?: Filter, observe?: 'body', reportProgress?: boolean): Observable<SearchResponse>;
    public auditSearchPost(body?: Filter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SearchResponse>>;
    public auditSearchPost(body?: Filter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SearchResponse>>;
    public auditSearchPost(body?: Filter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<SearchResponse>('post',`${this.basePath}/audit/search`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
