...
/**
 * Cuadro de mando o dashboard que consiste en un conjunto de widgets.
 */
export interface Dashboard { 
    ...
    /**
     * Pte definir según necesidades de componente dashboard para definir las posiciones y tamaño de los widgets
     */
