...
export class InteraccionesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public interactionsTypesIdentificatorGet(identificator: string, observe?: 'body', reportProgress?: boolean): Observable<Array<InteractionType>>;
    public interactionsTypesIdentificatorGet(identificator: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InteractionType>>>;
    public interactionsTypesIdentificatorGet(identificator: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InteractionType>>>;
    public interactionsTypesIdentificatorGet(identificator: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<InteractionType>>('get',`${this.basePath}/interactions/types/${encodeURIComponent(String(identificator))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
