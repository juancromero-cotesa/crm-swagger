...
import { WidgetChartWidgetIndicator } from '../model/widgetChartWidgetIndicator';
...
export class WidgetsService {
     ...
     */
    public widgetGet(observe?: 'body', reportProgress?: boolean): Observable<Array<WidgetChart | WidgetIndicator>>;
    public widgetGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<WidgetChart | WidgetIndicator>>>;
    public widgetGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<WidgetChart | WidgetIndicator>>>;
    public widgetGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<WidgetChart | WidgetIndicator>>('get',`${this.basePath}/widget`,
            {
