 ...
 */
import { CensusEntity } from './censusEntity';
import { CensusViaType } from './censusViaType';
...
export interface Address { 
     ...
     */
    country: string;
    province: CensusEntity;
    municipality: CensusEntity;
    city: CensusEntity;
    /**
     * Código postal
     */
    zipCode: number;
    /**
     * Controla si la direccion no llega de otros sistemas y es forzada por el usuario.
     */
    forcedAddress: boolean;
}