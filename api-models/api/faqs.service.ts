...
export class FaqsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public faqsFileFileIdDelete(fileId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public faqsFileFileIdDelete(fileId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public faqsFileFileIdDelete(fileId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public faqsFileFileIdDelete(fileId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (fileId === null || fileId === undefined) {
            throw new Error('Required parameter fileId was null or undefined when calling faqsFileFileIdDelete.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/faqs/file/${encodeURIComponent(String(fileId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * 
     * Carga un archivo con su nombre y descripción (definicion provisional)
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public faqsFilePost(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public faqsFilePost(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public faqsFilePost(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public faqsFilePost(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/faqs/file`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
