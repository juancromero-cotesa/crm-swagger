...
/**
 * Petición de filtrado paginado sobre una colección
 */
export interface Filter { 
    /**
     * primer elemento a retornar de los resultados
     */
    first?: number;
    /**
     * Numero de elementos a retornar de los resultados
     */
    rows?: number;
    /**
     * Objeto de filtrado
    ...
    /**
     * Orden , 1 para ascendente  y  -1 para descendente en ordenación simple
     */
    sortOrder?: number;
    /**
     * Campo por el que ordenqar en el modo de ordenación simple
     */
    sortField?: string;
    /**
     * Filtro global para realiar filtrado en distintos campos
     */
    globalFilter?: string;
    /**
     * Objeto de ordenación múltiple
     */
    multiSortMeta?: Array<SortMetadata>;
}