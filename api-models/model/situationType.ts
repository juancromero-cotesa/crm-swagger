...
export interface SituationType { 
    ...
    description: string;
    /**
     * Id de la unidad organizativa que genera la situación, sólo usuarios de esa uo podrán establecer esta situación. Puede ser nula con lo cual la situación sería aplicable a todos
     */
    organizationalUnitId: string;
    /**
     * Indica si es un estado definitivo el cual provoca el cierre de la entidad a la que se aplica
     */
    finalState: boolean;
    /**
     * Indica si es una situación usada por el sistema por lo que no se podrá modificar ni eliminar.
     */
    systemSituationType: boolean;
    /**
     * indica si los sucesores están restringidos y sólo podrán ser aquellos incluidos en el array de sucesores
     */
    restrictedSuccessors: boolean;
    /**
     * Situaciones que le pueden suceder, si el tipo de situación es definitiva no deberían suceder ninguna situación
     */
    successors: Array<SituationType>;
}