...
export class FuentesDeDatosService {
    ...
    /**
     * Obiene fuente de datos identificada
     * Retorna la configuracion 
     * @param dataSourceId 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public datasourcesDataSourceIdGet(dataSourceId: string, observe?: 'body', reportProgress?: boolean): Observable<DataSource>;
    public datasourcesDataSourceIdGet(dataSourceId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DataSource>>;
    public datasourcesDataSourceIdGet(dataSourceId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DataSource>>;
    public datasourcesDataSourceIdGet(dataSourceId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (dataSourceId === null || dataSourceId === undefined) {
            throw new Error('Required parameter dataSourceId was null or undefined when calling datasourcesDataSourceIdGet.');
        }
        ...
        return this.httpClient.request<DataSource>('get',`${this.basePath}/datasources/${encodeURIComponent(String(dataSourceId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * Obiene todas las fuentes de datos publicadas (BORRADOR)
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datasourcesGet(observe?: 'body', reportProgress?: boolean): Observable<Array<DataSource>>;
    public datasourcesGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<DataSource>>>;
    public datasourcesGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<DataSource>>>;
    public datasourcesGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<DataSource>>('get',`${this.basePath}/datasources`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
