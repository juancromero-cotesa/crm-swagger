...
export interface Interaction { 
    ...
    detail: string;
    /**
     * Situaciones de la interacción en el caso de interacciones serán creadas y cerradas nomalmente por el agente ya que en otro caso hay que generar una solicitud pero se deja abierto para p oder tener tiempos de resolución, atención,... type: array items: $ref: 
     */
    situations: ModelObject;
    /**
