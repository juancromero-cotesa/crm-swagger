...
/**
 * series de datos a mostrar en widgets
 */
export interface DataSerie { 
    datasource?: DataSource;
    /**
     * campo de la fuente de datos a mostrar en la serie
     */
    dataSourceField?: string;
    /**
     * campo de la fuente de datos a usar como label (etiqueta de descripción) de los datos
     */
    dataSourceFieldForLabel?: string;
    /**
     * nombre de la serie
     */
    name?: string;
