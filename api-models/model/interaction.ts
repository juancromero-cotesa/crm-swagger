...
/**
 * Acción que realiza una persona, componente o sistema relacionado con la iniciativa que no precisa de gestión
 */
export interface Interaction { 
     ...
     */
    interactionDiscriminator?: Interaction.InteractionDiscriminatorEnum;
    userAgent: UserBasic;
    /**
    ...
    subjectId?: string;
    /**
     * ID del componente o aplicación que genera la interacción, en las interactivas será CRM y en el resto será una aplicación previamente identificada
     */
    sourceExternalAplicationId: string;
    interactionType: InteractionType;
    /**
     * Dirección de la interacción persona->sistema o viceversa
     */
    interactionDirection: Interaction.InteractionDirectionEnum;
    /**
     * Detalle de la interacción
     */
    detail: string;
    /**
     * Situaciones de la interacción en el caso de interacciones serán creadas y cerradas nomalmente por el agente ya que en otro caso hay que generar una solicitud pero se deja abierto para poder tener tiempos de resolución, atención,...
     */
    situations: Array<Situation>;
    /**
     * Comentarios a la interacción
     */
    comments: Array<Comment>;
    /**
     * Fecha de creación en formato según RFC 3339, section 5.6
     */
    createDate: string;
    /**
     * Fecha de última modificación en formato según RFC 3339, section 5.6
     */
    lastModifiedDate: string;
    customFormData: any;
}
export namespace Interaction {
    export type InteractionDiscriminatorEnum = 'InteractionBatch' | 'InteractionInteractive';
    export const InteractionDiscriminatorEnum = {
        InteractionBatch: 'InteractionBatch' as InteractionDiscriminatorEnum,
        InteractionInteractive: 'InteractionInteractive' as InteractionDiscriminatorEnum
    };
    export type InteractionDirectionEnum = 'inbound' | 'outbound';
    export const InteractionDirectionEnum = {
        Inbound: 'inbound' as InteractionDirectionEnum,
        Outbound: 'outbound' as InteractionDirectionEnum
    };
}