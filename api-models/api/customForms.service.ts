...
export class CustomFormsService {
    ...
    /**
     * Elimina un formulario custom.
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public customFormDelete(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public customFormDelete(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public customFormDelete(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public customFormDelete(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/CustomForm`,
            {
