...
import { ForcedVia } from '../model/forcedVia';
...
export class PersonasService {
     ...
     * retorna todas las vías que existen en personas con el check forced a true, solo retornará las distintas teniendo en cuenta las propiedades de ForcedVia
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public personsForcedviasGet(observe?: 'body', reportProgress?: boolean): Observable<Array<ForcedVia>>;
    public personsForcedviasGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ForcedVia>>>;
    public personsForcedviasGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ForcedVia>>>;
    public personsForcedviasGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<ForcedVia>>('get',`${this.basePath}/persons/forcedvias`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
