...
export interface Widget { 
    ...
    description: string;
    /**
     * discriminador tipo de widget
     */
    widgetType: Widget.WidgetTypeEnum;
    userOwnerId: string;
    /**
     * unidades organizativas a las que se permite el uso del widget. Los datos obtenidos dependerán del datasource configurado en el widget
     */
    organizationalUnits: Array<OrganizationalUnit>;
}
export namespace Widget {
    export type WidgetTypeEnum = 'chart' | 'indicator' | 'table';
    export const WidgetTypeEnum = {
        Chart: 'chart' as WidgetTypeEnum,
        Indicator: 'indicator' as WidgetTypeEnum,
        Table: 'table' as WidgetTypeEnum
    };
}