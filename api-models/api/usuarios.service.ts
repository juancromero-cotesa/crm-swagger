...
export class UsuariosService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersUserIdDefaultdashboardPut(body: UserDashboard, userId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public usersUserIdDefaultdashboardPut(body: UserDashboard, userId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public usersUserIdDefaultdashboardPut(body: UserDashboard, userId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public usersUserIdDefaultdashboardPut(body: UserDashboard, userId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
