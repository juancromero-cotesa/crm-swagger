...
/**
 * objeto de login Federado, permitirá hacer login mediante usuario, teléfono, email o tarjeta ciudadana en una aplicación de terceros. Si se proporciona mas de un método de identificación se devolverá error en la petición
 */
export interface LoginFid { 
    appId?: string;
    allOf?: Login;
}