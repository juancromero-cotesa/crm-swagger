...
/**
 * Interaccion que se captura de forma desatendida desde un componente o aplicación de terceros
 */
export interface InteractionBatch extends Interaction { 
    /**
     * descripción del elemento que genera la interacción
     */
    sourceElementDescription: string;
    /**
     * identificador externo del elemento que genera la interacción
     */
    sourceElementExternalId?: string;
    geom: any;
}
export namespace InteractionBatch {
}