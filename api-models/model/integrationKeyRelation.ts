...
/**
 * objeto de relación entre persona y datos de importación
 */
export interface IntegrationKeyRelation { 
    /**
     * Campo origen de la relación en el sistema externo
     */
    integrationSourceField?: string;
    /**
     * Campo destino de la relación en CRM
     */
    crmSourceField?: string;
}