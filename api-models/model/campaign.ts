 ...
 */
import { CampaignFieldsMap } from './campaignFieldsMap';
import { DataSource } from './dataSource';
import { UserBasic } from './userBasic';

/**
 * Esqeuma de campaña para la integración con C7, Dado que las campañas son fijas, para CRM una campaña será un canal
 */
export interface Campaign { 
    /**
     * id de la campaña en CRM
     */
    _id: string;
    /**
    ...
    name: string;
    /**
     * Nombre interno en Contact Center
     */
    campaignIdName: string;
    /**
     * nombre de la lista de la campaña donde cargar los contactos
     */
    campaignListName: string;
    /**
     * tipo de campaña,.. email, telefono, sms,...
     */
    type: string;
    /**
    ...
    subject?: string;
    /**
     * texto a enviar en la campaña cuando en los tipos de campañas que no usan plantilla
     */
    text?: string;
    /**
     * Id de la plantilla de la KB de Contact Center que se usará en la campaña CRM
     */
    template: number;
    datasource: DataSource;
    /**
     * elementos del datasource en la ejecuación de la carga en la lista
     */
    readonly datasourceItemsOnLoad?: number;
    /**
     * elementos que retornaron error en la carga en la lista
     */
    readonly loadErrorsOnLoad?: number;
    /**
     * ¡¡ Pendiente de validar !! Mapeo de campos entre los campos de la plantilla y los campos del datasource
     */
    fieldsMap: Array<CampaignFieldsMap>;
    /**
     * indica si la campaña está desabilitada
     */
    disabled: boolean;
    readonly userOwner?: UserBasic;
    /**
     * fecha hora de planificación
     */
