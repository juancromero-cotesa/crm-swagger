 ...
 */
import { CrmFeaturePermissions } from './crmFeaturePermissions';

/**
 * Permisos de usuario. Es un objeto con una estructura de permisos por feature
 */
export interface CrmPermissions extends null<String, CrmFeaturePermissions> { 
  [key: string]: CrmFeaturePermissions;
