...
@Injectable()
export class DashboardsDeUsuariosService {
     ...
     */
    public usersDashboardsGet(observe?: 'body', reportProgress?: boolean): Observable<Array<UserDashboard>>;
    public usersDashboardsGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<UserDashboard>>>;
    public usersDashboardsGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<UserDashboard>>>;
    public usersDashboardsGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<UserDashboard>>('get',`${this.basePath}/usersDashboards`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersDashboardsIdDelete(id: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public usersDashboardsIdDelete(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public usersDashboardsIdDelete(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public usersDashboardsIdDelete(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling usersDashboardsIdDelete.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/usersDashboards/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersDashboardsIdGet(id: string, observe?: 'body', reportProgress?: boolean): Observable<UserDashboard>;
    public usersDashboardsIdGet(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserDashboard>>;
    public usersDashboardsIdGet(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserDashboard>>;
    public usersDashboardsIdGet(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling usersDashboardsIdGet.');
        }
        ...
        return this.httpClient.request<UserDashboard>('get',`${this.basePath}/usersDashboards/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * save
     * 
     * @param body usersDashboards
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public usersDashboardsPost(body: UserDashboard, observe?: 'body', reportProgress?: boolean): Observable<UserDashboard>;
    public usersDashboardsPost(body: UserDashboard, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserDashboard>>;
    public usersDashboardsPost(body: UserDashboard, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserDashboard>>;
    public usersDashboardsPost(body: UserDashboard, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling usersDashboardsPost.');
        }
        ...
        return this.httpClient.request<UserDashboard>('post',`${this.basePath}/usersDashboards`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * update
     * 
     * @param body usersDashboard
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public usersDashboardsPut(body: UserDashboard, observe?: 'body', reportProgress?: boolean): Observable<UserDashboard>;
    public usersDashboardsPut(body: UserDashboard, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserDashboard>>;
    public usersDashboardsPut(body: UserDashboard, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserDashboard>>;
    public usersDashboardsPut(body: UserDashboard, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling usersDashboardsPut.');
        }
        ...
        return this.httpClient.request<UserDashboard>('put',`${this.basePath}/usersDashboards`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
