...
import { DataSourceQuery } from '../model/dataSourceQuery';
...
export class FuentesDeDatosService {
    ...
    /**
     * 
     * Crea una agreación [ampliar]
     * @param body aggregate
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public datasourceAggregatePost(body: DataSourceQuery, observe?: 'body', reportProgress?: boolean): Observable<DataSourceQuery>;
    public datasourceAggregatePost(body: DataSourceQuery, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DataSourceQuery>>;
    public datasourceAggregatePost(body: DataSourceQuery, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DataSourceQuery>>;
    public datasourceAggregatePost(body: DataSourceQuery, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling datasourceAggregatePost.');
        }
        ...
        return this.httpClient.request<DataSourceQuery>('post',`${this.basePath}/datasource/aggregate`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datasourceCollectionsfieldsCollectionGet(collection: string, observe?: 'body', reportProgress?: boolean): Observable<Array<string>>;
    public datasourceCollectionsfieldsCollectionGet(collection: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<string>>>;
    public datasourceCollectionsfieldsCollectionGet(collection: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<string>>>;
    public datasourceCollectionsfieldsCollectionGet(collection: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<string>>('get',`${this.basePath}/datasource/collectionsfields/${encodeURIComponent(String(collection))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datasourceDataSourceIdDelete(dataSourceId: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public datasourceDataSourceIdDelete(dataSourceId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public datasourceDataSourceIdDelete(dataSourceId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public datasourceDataSourceIdDelete(dataSourceId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('delete',`${this.basePath}/datasource/${encodeURIComponent(String(dataSourceId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public datasourcePut(body: DataSource, observe?: 'body', reportProgress?: boolean): Observable<DataSource>;
    public datasourcePut(body: DataSource, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DataSource>>;
    public datasourcePut(body: DataSource, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DataSource>>;
    public datasourcePut(body: DataSource, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<DataSource>('put',`${this.basePath}/datasource`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Obtiene los datos resultado de una fuente de datos
     * Retorna la configuracion 
     * @param dataSourceId 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public datasourcesDataSourceIdDataGet(dataSourceId: string, observe?: 'body', reportProgress?: boolean): Observable<ModelObject>;
    public datasourcesDataSourceIdDataGet(dataSourceId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ModelObject>>;
    public datasourcesDataSourceIdDataGet(dataSourceId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ModelObject>>;
    public datasourcesDataSourceIdDataGet(dataSourceId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (dataSourceId === null || dataSourceId === undefined) {
            throw new Error('Required parameter dataSourceId was null or undefined when calling datasourcesDataSourceIdDataGet.');
        }
        ...
        return this.httpClient.request<ModelObject>('get',`${this.basePath}/datasources/${encodeURIComponent(String(dataSourceId))}/data`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * findCollectionByQuery
     * 
     * @param body query
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public findCollectionByQueryUsingPOST(body: DataSourceQuery, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public findCollectionByQueryUsingPOST(body: DataSourceQuery, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public findCollectionByQueryUsingPOST(body: DataSourceQuery, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public findCollectionByQueryUsingPOST(body: DataSourceQuery, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling findCollectionByQueryUsingPOST.');
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/datasource/find`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
